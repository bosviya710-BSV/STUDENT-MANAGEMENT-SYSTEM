...
SECRET_KEY = 'django-insecure-sms-student-management-system-college-project-key-2026'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR],  # Allows serving index.html at root url
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# CORS Configuration
# Enables browser requests from standalone index.html or live-servers
